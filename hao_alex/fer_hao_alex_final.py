...
# load the data
X_train = np.load('../data_store/fer_X_train_final.npy')
X_test = np.load('../data_store/fer_X_test_smooth.npy')
y_train = np.load('../data_store/fer_y_train_final.npy')
